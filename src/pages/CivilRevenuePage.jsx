        ...
        <div className="container mx-auto px-6 py-24 relative">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 bg-amber-500 text-white px-3 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold hover:bg-amber-600 transition-colors text-xs sm:text-base"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-white/10 text-white px-3 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold border border-white/20 hover:bg-white/20 transition-colors text-xs sm:text-base"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
