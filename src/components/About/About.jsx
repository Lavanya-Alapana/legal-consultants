    ...
    <div className="w-full">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container max-w-7xl mx-auto px-5">
          <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <div>
              <h2 className="text-3xl font-bold text-blue-900 mb-8">Professional Background</h2>
              ...
              <div className="mt-10 bg-white p-8 rounded-lg shadow-md">
                <h3 className="text-2xl font-bold text-blue-900 mb-5">Key Practice Areas</h3>
                <ul className="grid md:grid-cols-2 gap-3">
                  <li className="py-2.5 px-4 bg-blue-50 border-l-4 border-blue-500 text-blue-900 font-medium">Legal Opinion on Property Transactions</li>
                  <li className="py-2.5 px-4 bg-blue-50 border-l-4 border-blue-500 text-blue-900 font-medium">Title Search & Due Diligence</li>
                  <li className="py-2.5 px-4 bg-blue-50 border-l-4 border-blue-500 text-blue-900 font-medium">Civil & Criminal Litigation</li>
                  <li className="py-2.5 px-4 bg-blue-50 border-l-4 border-blue-500 text-blue-900 font-medium">Land and Revenue Matters</li>
                  <li className="py-2.5 px-4 bg-blue-50 border-l-4 border-blue-500 text-blue-900 font-medium">Family Settlements & Inheritance</li>
                  <li className="py-2.5 px-4 bg-blue-50 border-l-4 border-blue-500 text-blue-900 font-medium">Property Disputes & Verification</li>
                  <li className="py-2.5 px-4 bg-blue-50 border-l-4 border-blue-500 text-blue-900 font-medium">Partition and Succession Suits</li>
                  <li className="py-2.5 px-4 bg-blue-50 border-l-4 border-blue-500 text-blue-900 font-medium">Injunction Orders & Legal Remedies</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-6xl mx-auto px-5">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-10 text-center">Our Team</h2>
          ...
          <div className="bg-gray-50 p-8 md:p-10 rounded-lg shadow-md grid md:grid-cols-[250px_1fr] gap-10 items-start">
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-blue-900 mb-2">Adv. Srinath</h3>
              <h4 className="text-lg md:text-xl text-blue-600 font-semibold mb-5">Senior Advocate | Family & Matrimonial Law</h4>
              <p className="text-base md:text-lg leading-relaxed text-gray-700 mb-5">
              ...
              <div className="my-8">
                <h5 className="text-xl font-bold text-blue-900 mb-4">Areas of Practice:</h5>
                <ul className="grid md:grid-cols-2 gap-3">
                  <li className="py-2.5 px-4 bg-white border-l-4 border-blue-500 text-blue-900 font-medium">Family & Matrimonial Litigation</li>
                  <li className="py-2.5 px-4 bg-white border-l-4 border-blue-500 text-blue-900 font-medium">Consumer Forum Representation</li>
                  <li className="py-2.5 px-4 bg-white border-l-4 border-blue-500 text-blue-900 font-medium">Motor Accident Compensation</li>
                  <li className="py-2.5 px-4 bg-white border-l-4 border-blue-500 text-blue-900 font-medium">Cheque Bounce Cases (Sec. 138 NI Act)</li>
                  <li className="py-2.5 px-4 bg-white border-l-4 border-blue-500 text-blue-900 font-medium">Money Recovery Suits</li>
                  <li className="py-2.5 px-4 bg-white border-l-4 border-blue-500 text-blue-900 font-medium">Contractual Disputes</li>
                  <li className="py-2.5 px-4 bg-white border-l-4 border-blue-500 text-blue-900 font-medium">Execution Petitions</li>
                  <li className="py-2.5 px-4 bg-white border-l-4 border-blue-500 text-blue-900 font-medium">Rent Control & Lease Disputes</li>
                </ul>
              </div>
