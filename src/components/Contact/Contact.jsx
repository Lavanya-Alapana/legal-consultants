const Contact = () => {
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="relative text-white py-24 md:py-32 text-center overflow-hidden min-h-[400px] flex items-center justify-center">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:vivek@getlegalopinion.com" className="text-blue-600 hover:text-blue-800 hover:underline">
